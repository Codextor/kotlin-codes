 ...
 *
 * For example,
 * once the pillow reaches the nth person they pass it to the n - 1th person, then to the n - 2th person and so on.
 ...
 * 2 <= n <= 1000
 * 1 <= time <= 1000
 * @see <a href="https://leetcode.com/problems/pass-the-pillow/">LeetCode</a>
 */

fun passThePillow(n: Int, time: Int): Int {
    val cycleLength = 2 * (n - 1)
    val effectiveTime = time % cycleLength
    return when {
        effectiveTime < n -> effectiveTime + 1
        else -> cycleLength - effectiveTime + 1
    }
}
